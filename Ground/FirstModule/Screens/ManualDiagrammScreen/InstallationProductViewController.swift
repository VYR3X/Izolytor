...
extension InstallationProductViewController: UITableViewDelegate {
...
extension InstallationProductViewController: UITableViewDataSource {
...
//			let item: Item = sections[1].items[indexPath.row]
		...
		case Section.manualSection.rawValue:
			...
			cell.bind(title: item.name, subTitle: item.detail, iconName: "addIcon")
...
extension InstallationProductViewController: ManualHeaderViewDelegate {
