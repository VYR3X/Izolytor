...
/// Протокол для взаимодействия с сервисом получения данных для главного экрана
protocol FirstServiceProtocol {

	/// Метод получения данных о продукте
...
class FirstService: FirstServiceProtocol {
	...
	func getProductType(completion: @escaping (Result<[ProductServiceModel.MainScreenProductModel], Error>) -> Void) {
		let product = [
			ProductServiceModel.MainScreenProductModel(
				gifName: "asd",
				typeName: "Трансформаторные вводы",
				models:
					[
						DescriptionProductModel(
							productName: "ГКТIII-171",
							model3DName: "3d model 171",
							schemeName: "модель 1"
						),
						DescriptionProductModel(
							productName: "ГКТIII-171-01",
							model3DName: "3d model 171",
							schemeName: "модель 2"
						)
					],
			...
			ProductServiceModel.MainScreenProductModel(
				...
				models: [
					DescriptionProductModel(
						productName: "ГКТIII-181",
						model3DName: "3d model 181",
						schemeName: "модель 1"
					),
					DescriptionProductModel(
						productName: "ГКТIII-181-01",
						model3DName: "3d model 181",
						schemeName: "модель 2"
					),
					DescriptionProductModel(
						productName: "ГКТIII-181-02",
						model3DName: "3d model 151",
						schemeName: "модель 3"
					),
					DescriptionProductModel(
						productName: "ГКТIII-181-03",
						model3DName: "3d model 151",
						schemeName: "модель 4"
					)
				],
			...
			ProductServiceModel.MainScreenProductModel(
				...
				models: [
					DescriptionProductModel(
						productName: "ГКТIII-191",
						model3DName: "3d model 191",
						schemeName: "модель 1"
					),
					DescriptionProductModel(
						productName: "ГКТIII-191-01",
						model3DName: "3d model 191",
						schemeName: "модель 2"
					)
				],
			...
			ProductServiceModel.MainScreenProductModel(
				...
				models: [
					DescriptionProductModel(
						productName: "ГКТIII-151",
						model3DName: "3d model 151",
						schemeName: "модель 1"
					),
					DescriptionProductModel(
						productName: "ГКТIII-151-01",
						model3DName: "3d model 151",
						schemeName: "модель 2"
					),
					DescriptionProductModel(
